    ...
    return (
        <div>
            ...
            {lovelyList.map((item, i) => (
                <div key={i}>
                    <div className="hero__lovely__card d-flex flex-row m-5">
                        <div><img
                            width="300px"
                        ...
                        <div className="card-body p-5">
                            ...
                            <ul className="hero_characteristics pt-5"><h1>Characteristics : </h1>
                                <li className="hero_name"> Height: {item.height}</li>
                                <li className="hero_birthday">Birth_year : {item.birth_year}</li>
